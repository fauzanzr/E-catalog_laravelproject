    ...
    <form action="{{ route('umkm.update', $umkm) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="container px-5">
            ...
            <div class="mb-3">
                ...
                @if ($umkm->logo_umkm)
                <img src="{{ asset('storage/' . $umkm->logo_umkm) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                @else
                <img class="img-preview img-fluid mb-3 col-sm-5">
                @endif

                <input class="form-control" type="file" id="logo_umkm" name="logo_umkm" onchange="previewImage()" onchange="previewImage()">
            </div>
